...
import Door.Access.Door8800.Command.Card.ReadCardDetail;
...
//关闭等待
    ...
    public void UploadCardList(){
        ...
        CardExpiry.set(2020,10-1, 28,10,10,10);//设置有效时间
    ...
    public void UploadSortCardList(){
        ...
        commandDetail.Identity = new Door8800Identity("AB-5812T17030234","FFFFFFFF",E_ControllerType.Door8800);//设置SN(16位字符)，密码(8位十六进制字符)，设备类型
        ArrayList<CardDetail> mCardList = new ArrayList<CardDetail>();
        //创建卡片信息
        CardDetail cd = new CardDetail();//设置卡号
          try{
    ...
    public void GetCard(){
        ...
        commandDetail.Timeout = 5000;
        ReadCardDetail_Parameter parameter=new  ReadCardDetail_Parameter(commandDetail,"11010567");
        ReadCardDetail cmd=new ReadCardDetail(parameter);
        _Allocator.AddCommand(cmd);
    }
    @Override
    public void CommandCompleteEvent(INCommand cmd, INCommandResult result) {
        System.out.println("命令完成");
        release();
    }
