...
- **Play up:** allowed within the same club — **never down**`,
      },
      {
        ...
        a: `- **Team insurance (mandatory):** each team **must carry its own** coverage and provide **proof** — Super6 Series LLC **does not** insure your team or substitute for your program's coverage
- **Liability:** Super6 Series LLC is **not responsible or liable** for injury, loss, damage, or other harm to **athletes, spectators, patrons**, or anyone else in connection with our events — **your team and your guests attend at your own risk**
- **When you sign up for an event:** you **consent** that **you are responsible for your party** — including **parents, friends, athletes, coaches**, and anyone you bring, register, or represent — **not Super6 Series LLC**
...
- **Only exception:** you **paid team registration** for an event **in your division**, and that **division is not played** because **Super6 Series LLC cannot field enough teams** to make the bracket — we send an **immediate refund**. **We do not hold your money**
...
- **Only exception:** **paid team registration** for a division that **Super6 Series LLC cancels** because **not enough teams** register to run it — **immediate refund**. **We do not hold your money**
...
- Plus a **$100 forfeit deposit** required before playing in any future Super6 Series LLC event
