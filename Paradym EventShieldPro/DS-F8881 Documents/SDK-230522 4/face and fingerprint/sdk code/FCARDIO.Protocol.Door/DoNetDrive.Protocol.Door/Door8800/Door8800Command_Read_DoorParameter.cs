...
namespace DoNetDrive.Protocol.Door.Door8800
{
    ...
    /// </summary>
    public abstract class Door8800Command_Read_DoorParameter : Door8800Command_ReadParameter
    {
        ...
        public Door8800Command_Read_DoorParameter(INCommandDetail cd, DoorPort_Parameter par) : base(cd, par)
        {
