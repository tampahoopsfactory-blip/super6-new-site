...
import Door.Access.Door89H.Command.Card.*;
...
//关闭等待
    ...
    public void GetCard(){
        ...
        commandDetail.Timeout = 5000;
        ReadCardDetail_Parameter parameter=new  ReadCardDetail_Parameter(commandDetail,"555555");
    ...
    public  void readCardDataBase(){
        ...
        commandDetail.Timeout = 5000;
        ReadCardDataBase_Parameter parameter=new ReadCardDataBase_Parameter(commandDetail,2);
