...
Public Declare Sub FPCONV_Init Lib "FpDataConv.dll" ()


'Get the dynamic library version number
Public Declare Function FPCONV_GetConvDLLModel Lib "FpDataConv.dll" (ByVal strModel As String) As Long
...
Public Declare Function FPCONV_GetFpDataValidity Lib "FpDataConv.dll" (ByRef bBuf As Byte) As Long
...
'apnSize - Buffer size
'Return value 0- success; Non-0 - failure
Public Declare Function FPCONV_GetFpDataVersionAndSize Lib "FpDataConv.dll" (ByRef bBuf As Byte, ByRef apnVersion As Long, ByRef apnSize As Long) As Long
...
'Return value 0- success; Non-0 - failure
Public Declare Function FPCONV_GetFpDataSize Lib "FpDataConv.dll" (ByVal anFpDataVersion As Long, ByRef apnFpDataSize As Long) As Long
...
'Return value 0- success; Non-0 - failure
Public Declare Function FPCONV_Convert Lib "FpDataConv.dll" (ByVal anSrcVer As Long, ByRef apSrcFpData As Byte, ByVal anDestVer As Long, ByRef apDestFpData As Byte) As Long
