...
namespace DoNetDrive.Protocol.Elevator.FC8864.Transaction.ReadTransactionDatabaseByIndex
{
    /// <summary>
    /// 读记录数据库
    ...
    /// </summary>
    public class ReadTransactionDatabaseByIndex : DoNetDrive.Protocol.Door.Door8800.Transaction.ReadTransactionDatabaseByIndex
    {
        /// <summary>
        /// 新记录实体创建工厂
        /// </summary>
